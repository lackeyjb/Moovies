...
class MovieData
  ...
  base_uri = 'http://api.rottentomatoes.com/api/public/v1.0.json?apikey=jxgwd4k8e289s23ygzxc5pae'

  attr_accessor :title, :year, :synopsis

  def initialize(title, year, synopsis)
    @title = title
    @year = year
    @synopsis = synopsis
  end
